...
public class ResetModel extends EntityModel<ResetEntity> {
	...
	@Override
	public void setAngles(ResetEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	}
	@Override
